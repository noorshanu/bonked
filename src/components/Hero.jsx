...
function Hero() {
  return (
    ...
    <a href="https://solscan.io/token/BSFjg8wpS8ZNvn4us4jwARw6XhxnGqE7z2EwDohR1Thh" className="text-sm sm:text-2xl font-bold text-center"> BSFjg8wpS8ZNvn4us4jwARw6XhxnGqE7z2EwDohR1Thh</a>
    </section>
  );
}
